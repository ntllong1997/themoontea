...
const CORNDOG_FLOW = {
    initial: 'received',
    states: {
        received: { next: 'making', badge: 'New', tooltip: 'Click to mark as Making', className: 'bg-red-50 text-red-900' },
        making: { next: 'ready', badge: 'Making…', tooltip: 'Click to mark as Ready', className: 'bg-red-100 text-red-900' },
        ready: { next: 'pickedup', badge: 'Ready ✓', tooltip: 'Click to mark as Picked Up', className: 'bg-red-300 text-red-900' },
        pickedup: { next: 'received', badge: 'Picked Up ✓', tooltip: 'Click to reset', className: 'bg-red-500 text-white' },
    },
};
...
const BOBA_FLOW = {
    initial: 'new',
    states: {
        new: { next: 'ready', badge: 'New', tooltip: 'Click to mark as Ready', className: 'bg-blue-100 text-blue-900' },
        ready: { next: 'pickedup', badge: 'Ready ✓', tooltip: 'Click to mark as Picked Up', className: 'bg-blue-300 text-blue-900' },
        pickedup: { next: 'new', badge: 'Picked Up ✓', tooltip: 'Click to reset', className: 'bg-blue-500 text-white' },
    },
};
 ...
 */
export const SIMPLE_FLOW = twoStepFlow('bg-amber-100 text-amber-900', 'bg-amber-500 text-white');

const COOKIE_FLOW = twoStepFlow('bg-orange-100 text-orange-900', 'bg-orange-500 text-white');
const LEMONADE_FLOW = twoStepFlow('bg-yellow-100 text-yellow-900', 'bg-yellow-500 text-white');
const EGG_ROLL_FLOW = twoStepFlow('bg-purple-100 text-purple-900', 'bg-purple-500 text-white');
...
const DISCOUNT_FLOW = {
    initial: 'applied',
    states: {
        applied: { next: 'applied', badge: 'Coupon', tooltip: '', className: 'bg-green-50 text-green-700' },
    },
};
