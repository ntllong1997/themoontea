...
/**
 * What a till records when the operator has not chosen otherwise. Matches the
 * iPad's default so both clients start from the same place, and is written in
 * the iPad's canonical casing so reports need no reconciliation.
 */
